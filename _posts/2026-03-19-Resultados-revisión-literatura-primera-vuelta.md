...
Socializar los resultados iniciales de la revisión de literature asociada al tema de homogenización inversa. 

## 2. Contexto general del proyecto

Estamos buscando abordar un problema de la mecánica de materiales porosos. Particularmente optimización de microestructuras para que produscan una propiedad mecánica en partícular.
